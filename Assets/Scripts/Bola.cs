...
{
        public int ganarCantidadGoles=3;
        public Text ganador;
    //Velocidad de la pelota
        ...
        //Clips de audio
        public AudioClip audioGol, audioRaqueta, audioRebote,salida;
        //Contadores de goles
    ...
    //Reproduzco el sonido del gol
        ...
        fuenteDeAudio.Play();
        if(golesIzquierda==ganarCantidadGoles){
            ganador.text="Gana Izquierda";
            Time.timeScale = 0;
            fuenteDeAudio.clip = salida;
            fuenteDeAudio.Play();
        }
        else if(golesDerecha==ganarCantidadGoles){

              ganador.text="Gana Derecha";
              Time.timeScale = 0;
              fuenteDeAudio.clip = salida;
                fuenteDeAudio.Play();
        }
